...
class Slider {
    constructor(slider) {
        ...
        this.time = (slider.time === undefined) ? 2000 : slider.time;
        this.timeAnimation = (slider.timeAnimation === undefined) ? 1000 : slider.timeAnimation;
        this.autoPlay = (slider.autoPlay === undefined) ? false : slider.autoPlay;
        this.position = (slider.position === undefined) ? 'left' : slider.position;
        this.deviation = (slider.deviation === undefined) ? '100%' : slider.deviation;
        this.deviationMin = (slider.deviationMin === undefined) ? '-100%' : slider.deviationMin;
        this.count = 0;
    }
